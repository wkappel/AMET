header <- "
###################### MODEL TO MODEL SPECIES SPATIAL PLOT ######################
### AMET CODE: AQ_Plot_Spatial_MtoM_Species.R 
###
### This code is part of the AMET-AQ system.  The Plot Spatial code takes a MYSQL 
### database query for a single species from one or more networks and plots the 
### observation value, model value, and  difference between the model and ob for 
### each site for each corresponding network.  Mutiple values for a site are averaged
