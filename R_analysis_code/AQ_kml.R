...
#                                                                       #
#                Google Earth KML Generation for  AQ Obs                #
#                            AQ_kml.R                                   #
#                                                                       #
...
## get some environmental variables and setup some directories
 ...
 sfctable       <-paste(project)
 writeLines(paste(mysql$server))
 writeLines(paste(sfctable))
