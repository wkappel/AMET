header <- "
########################### MODEL TO MODEL TIME SERIES PLOT ###############################
### AMET CODE: AQ_Timeseries_MtoM.R
###
### This script is part of the AMET-AQ system.  It plots a timeseries for a single network, 
### single species and multiple simulations. Data are averages across time and space to create
