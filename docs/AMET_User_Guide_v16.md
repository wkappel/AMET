...
| **Variable**   | **Description** |
|----------------|-----------------|
| **AMETBASE**                     | Base directory where AMET is installed. This environment variable is commented out by default to allow users to set AMETBASE manually in their enviroment using "setenv AMETBASE /home/AMETv16". Users can also opt to use the script to set the AMETBASE environment variable.|
...
**run\_bugleplot.csh** ([Example Plot](./images/aqExample_SO4_1_bugleplot_bias.png))
...
**run\_plot\_spatial\_mtom.csh** ([Example Plot](./images/aqExample_SO4_1_spatialplot_mtom_diff_avg.png))
...
**run\_scatterplot\_density.csh** ([Example Plot](./images/aqExample_O3_8hrmax_1_scatterplot_density.png))
...
**run\_scatterplot\_soil.csh** ([Example Plot](./images/aqExample_PM25_TOT_1_scatterplot_soil.png))
...
| **PROFM**                | Produce upper-air profile statistics from mandatory level data for specified sites, lat-lon bounds, state, country, region, etc.
| **PROFN**                | Produce single-time comparison of model profiles of temperature and relative humidity with the RAOB profile on their native levels.
...
| **SPATIALM**             | Produce upper-air spatial statistics for defined layer and lat-lon bounds.
...
| **TSERIESM**             | Produce upper-air statistics timeseries plots and text output for specified layer, sites, lat-lon bounds, state, country, region, etc.
