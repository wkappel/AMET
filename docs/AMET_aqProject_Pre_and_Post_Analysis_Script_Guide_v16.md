...
Set the environment variable $AMETBASE to your local path

```
setenv AMETBASE /your_local_path/AMET_v16
```
...
```
 ...
 RENAME_PROJECT         Rename an existing AMET project, retaining all existing data. Must also set CREATE_PROJECT to T
                        to invoke. Must also specify new project name using the environment variable NEW_AMET_PROJECT_NAME.
                        Choices are T,F.
