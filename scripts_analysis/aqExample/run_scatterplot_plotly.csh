#!/bin/csh -f
# --------------------------------
# Multi-network scatterplot using plotly 
# -----------------------------------------------------------------------
# Purpose:
#
...
# single simulation. This script uses the plotly R package. The output
# from this script is an interactive html file..
#
...
# -----------------------------------------------------------------------
  ...
  setenv AMET_OUT       $AMETBASE/output/$AMET_PROJECT/scatterplot_plotly
...
#> Non-standard networks (should probably be set to F unless specifically required)
  ...
  setenv AMET_LOG scatterplot_plotly.log
...
##--------------------------------------------------------------------------##
  ...
  R CMD BATCH --no-save --slave $AMETBASE/R_analysis_code/AQ_Scatterplot_plotly.R $AMET_LOG
