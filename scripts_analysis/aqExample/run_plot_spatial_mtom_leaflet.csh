#!/bin/csh -f
# -----------------------------------------------------------------------
# Spatial plot - Model to Model (leaflet)
# -----------------------------------------------------------------------
# Purpose:
#
...
# one observation network must be specified. This version of the MtoM 
# plot utilizes the leaflet R package to create an interactive html plot.
#
# Initial version:  K. Wyat Appel - Apr, 2022
#
...
# -----------------------------------------------------------------------
  ...
  setenv AMET_OUT       $AMETBASE/output/$AMET_PROJECT/plot_spatial_mtom_leaflet
...
#> Non-standard networks (should probably be set to F unless specifically required)
  ...
  setenv AMET_LOG plot_spatial_mtom_leaflet.log
...
##--------------------------------------------------------------------------##
  ...
  R CMD BATCH --no-save --slave $AMETBASE/R_analysis_code/AQ_Plot_Spatial_MtoM_leaflet.R $AMET_LOG
