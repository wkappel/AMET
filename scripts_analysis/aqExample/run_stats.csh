...
# Purpose:
#
# This code creates csv file containing number statistics (e.g. NMB, NME,
# MB, ME, FB, FE, RMSE, correlation) but no plots. This script accepts
...
# -----------------------------------------------------------------------
  ...
  setenv AMET_OUT       $AMETBASE/output/$AMET_PROJECT/stats
...
##--------------------------------------------------------------------------##
  ...
  R CMD BATCH --no-save --slave $AMETBASE/R_analysis_code/AQ_Stats.R $AMET_LOG
