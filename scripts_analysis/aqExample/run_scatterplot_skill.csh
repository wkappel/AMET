...
# -----------------------------------------------------------------------
  ...
  ###  and plot type)
  setenv AMET_TITLE "Skill Scatterplot $AMET_PROJECT $AMET_SDATE - $AMET_EDATE"
...
##--------------------------------------------------------------------------##
  ...
  R CMD BATCH --no-save --slave $AMETBASE/R_analysis_code/AQ_Scatterplot_skill.R $AMET_LOG
  ...
  if($AMET_R_STATUS == 0) then
		...
		echo "-----------------------------------------------------------------------------------------"
		echo "Plots ----------------------->" $AMET_OUT/${AMET_PROJECT}_${AMET_AQSPECIES}_${AMET_PID}_scatterplot_skill.$AMET_PTYPE
		echo "Data File ------------------->" $AMET_OUT/${AMET_PROJECT}_${AMET_AQSPECIES}_${AMET_PID}_scatterplot_skill_data.csv
		echo "-----------------------------------------------------------------------------------------"
		exit 0
  else
