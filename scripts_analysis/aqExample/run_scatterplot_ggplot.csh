#!/bin/csh -f
# --------------------------------
# Multi-network scatterplot using ggplot2
# -----------------------------------------------------------------------
# Purpose:
#
...
# single simulation. This script uses the ggplot2 R package. The output
# from this script is pdf, png and csv files.
#
...
# -----------------------------------------------------------------------
  ...
  setenv AMET_OUT       $AMETBASE/output/$AMET_PROJECT/scatterplot_ggplot
...
#> Non-standard networks (should probably be set to F unless specifically required)
  ...
  setenv AMET_LOG scatterplot_ggplot.log
...
##--------------------------------------------------------------------------##
  ...
  R CMD BATCH --no-save --slave $AMETBASE/R_analysis_code/AQ_Scatterplot_ggplot.R $AMET_LOG
