...
##--------------------------------------------------------------------------##
  ...
  if($AMET_R_STATUS == 0) then
		...
		echo "-----------------------------------------------------------------------------------------"
		echo "Plots -----------------------> $AMET_OUT/${AMET_PROJECT}_${AMET_AQSPECIES}_${AMET_PID}_scatterplot_density_ggplot.$AMET_PTYPE"
		echo "Data File -------------------> $AMET_OUT/${AMET_PROJECT}_${AMET_AQSPECIES}_${AMET_PID}_scatterplot_density_ggplot.csv"
		echo "-----------------------------------------------------------------------------------------"
		exit 0
  else
