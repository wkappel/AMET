...
# -----------------------------------------------------------------------
  ...
  setenv AMET_OUT       $AMETBASE/output/$AMET_PROJECT/timeseries_ggplot
...
#> Non-standard networks (should probably be set to F unless specifically required)
  ...
  setenv AMET_LOG timeseries_ggplot.log
...
setenv AMETRINPUT $AMETBASE/scripts_analysis/$AMET_PROJECT/input_files/all_scripts.input
  ...
  R CMD BATCH --no-save --slave $AMETBASE/R_analysis_code/AQ_Timeseries_ggplot.R $AMET_LOG
