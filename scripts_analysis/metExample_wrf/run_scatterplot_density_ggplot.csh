#!/bin/csh -f
# -----------------------------------------------------------------------
# Density Scatterplot using ggplot
# -----------------------------------------------------------------------
# Purpose:
#
...
# where the largest number of points on the plot occur. This version of
# the density scatter plot uses the ggplot R package.
#
...
# -----------------------------------------------------------------------
  ...
  setenv AMET_OUT       $AMETBASE/output/$AMET_PROJECT/scatterplot_density_ggplot
...
#> Met networks
  ...
  setenv AMET_LOG scatterplot_density_ggplot.log
...
##--------------------------------------------------------------------------##
  ...
  R CMD BATCH --no-save --slave $AMETBASE/R_analysis_code/AQ_Scatterplot_density_ggplot.R $AMET_LOG
  ...
  if($AMET_R_STATUS == 0) then
		...
		echo "-----------------------------------------------------------------------------------------"
		echo "Plots -----------------------> $AMET_OUT/${AMET_PROJECT}_${AMET_METSPECIES}_${AMET_PID}_scatterplot_density_ggplot.$AMET_PTYPE"
		echo "Data File -------------------> $AMET_OUT/${AMET_PROJECT}_${AMET_METSPECIES}_${AMET_PID}_scatterplot_density_ggplot.csv"
		echo "-----------------------------------------------------------------------------------------"
		exit 0
  else
