#!/bin/csh -f
  ...
  # NOTES: run_info_MET.R needs modification PRISM section model_outdir & amet_gui=T
  R --no-save --slave < ${AMETBASE}/R_analysis_code/MET_wrapper.R 

  setenv WRAPPER_RUNID PR.AN
  R --no-save --slave < ${AMETBASE}/R_analysis_code/MET_wrapper.R 
