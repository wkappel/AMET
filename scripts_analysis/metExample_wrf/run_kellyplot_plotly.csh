...
##--------------------------------------------------------------------------##
  ...
  echo
		...
		echo "-----------------------------------------------------------------------------------------"
		echo "Plot   ---------->" $AMET_OUT/${AMET_PROJECT}_${AMET_METSPECIES}_${AMET_PID}_Kellyplot_NMB.$AMET_PTYPE
                echo "Plot   ---------->" $AMET_OUT/${AMET_PROJECT}_${AMET_METSPECIES}_${AMET_PID}_Kellyplot_NME.$AMET_PTYPE
                echo "Plot   ---------->" $AMET_OUT/${AMET_PROJECT}_${AMET_METSPECIES}_${AMET_PID}_Kellyplot_MB.$AMET_PTYPE
                echo "Plot   ---------->" $AMET_OUT/${AMET_PROJECT}_${AMET_METSPECIES}_${AMET_PID}_Kellyplot_ME.$AMET_PTYPE
                echo "Plot   ---------->" $AMET_OUT/${AMET_PROJECT}_${AMET_METSPECIES}_${AMET_PID}_Kellyplot_RMSE.$AMET_PTYPE
                echo "Plot   ---------->" $AMET_OUT/${AMET_PROJECT}_${AMET_METSPECIES}_${AMET_PID}_Kellyplot_Corr.$AMET_PTYPE
                echo "Plot   ---------->" $AMET_OUT/${AMET_PROJECT}_${AMET_METSPECIES}_${AMET_PID}_Kellyplot_data.csv 
		echo "-----------------------------------------------------------------------------------------"
		exit(0)
  else
