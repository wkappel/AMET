...
con   <- dbConnect(MariaDB(),user=mysql_login,password=mysql_pass,host=mysql_server)
if (!exists("con")) {
...
aq_new_2  <- "create table aq_project_log (proj_code varchar(100) UNIQUE KEY, log_id varchar(100), model varchar(20), user_id varchar(40), passwd varchar(25), email varchar(100), description text, proj_date timestamp, proj_time time, min_date datetime, max_date datetime)"
aq_new_3  <- "create table site_metadata (stat_id varchar(25) UNIQUE KEY, num_stat_id int(25), stat_name varchar(100), network varchar(25), monitor_type varchar(200), co_network varchar(200), state varchar(4), city varchar(50), start_date varchar(20), end_date varchar(20), lat double, lon double, elevation int(10), landuse varchar(50), loc_setting varchar(50), county varchar(100), country varchar(100), near_road varchar(10), timezone varchar(20), GMT_Offset double, NLCD2011_Imperv_Surf_Frac double,NLCD2011_Imperv_Surf_Loc_Setting varchar(100),NLCD2006_Imperv_Surf_Frac double, NLCD2006_Imperv_Surf_Loc_Setting varchar(100), NLCD2001_Imperv_Surf_Frac double, NLCD2001_Imperv_Surf_Loc_Setting varchar(100),daily_o3_jandec varchar(10),daily_o3_maysep varchar(10),daily_pm_mass_and_specs_jandec varchar(10),daily_pm_mass_only_jandec varchar(10),daily_pm_specs_only_jandec varchar(10),daily_voc_benz_jandec varchar(10),daily_voc_etha_jandec varchar(10),daily_voc_ethy_jandec varchar(10),daily_voc_isop_jandec varchar(10),hourly_co_jandec varchar(10),hourly_o3_jandec varchar(10),hourly_pm25_jandec varchar(10),hourly_pm10_jandec varchar(10),hourly_etha_jandec varchar(10),hourly_ethy_jandec varchar(10),hourly_isop_jandec varchar(10),hourly_so2_jandec varchar(10),hourly_no_jandec varchar(10),hourly_no2_jandec varchar(10),hourly_noy_jandec varchar(10),hourly_tolu_jandec varchar(10),hourly_nox_jandec varchar(10))"
