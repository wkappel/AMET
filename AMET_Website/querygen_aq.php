...
$l[9]="$R_script --no-save --verbose $amet_base/R_analysis_code/".$_POST['run_program']." \n";
...
<div align="left"><font face="Arial, Helvetica, sans-serif">
    ...
    <optgroup label="Stacked Bar Plots">
	    <option value="AQ_Stacked_Barplot.R"><font face="Arial, Helvetica, sans-serif">PM2.5 Stacked Bar Plot (AQS Daily,CSN,IMPROVE; multi run)</font></option>
	    <option value="AQ_Stacked_Barplot_AE6.R"><font face="Arial, Helvetica, sans-serif">PM2.5 Stacked Bar Plot AE6 (AQS Daily,CSN,IMPROVE; multi run)</font></option>
	    ...
	    <option value="AQ_Stacked_Barplot_soil.R"><font face="Arial, Helvetica, sans-serif">Soil Stacked Bar Plot (AQS Daily,CSN,IMPROVE; multi run)</font></option>
